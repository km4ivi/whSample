...
The defaults for these arguments are *backups=0* and *seed=NULL*. The default seed will tell *sampler* to use the current system time in milliseconds (a common seeding approach).
